<?php get_header(); ?>
	...
	<div class="page-header">
		<div class="container">
			<h2 class="page-title pull-left">Single Blog Post</h2>
			<ol class="breadcrumb">
				<?php 
						...
						<article class="entry-post">
							...
							<div class="entry-content clearfix">
								<figure class="featured-image">
									...
									?>
									<img src="<?php echo $thumb_img[0]; ?>" class="img-responsive" alt="<?php the_title() ?>">
								</figure>
								<div class="content">
									<?php the_content(); ?>
								</div>
				...
				<div class="col-md-3">
					...
					<?php
						if( function_exists( 'dynamic_sidebar' ) ){
							if ( !dynamic_sidebar( 'tdv-blog' ) && current_user_can('edit_theme_options') ) :

				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div class="newsletter">
							<h3 class="footer-heading">Nieuwsletter</h3>
...
<!--                            <p>Get the latest update from us by subscribing to our newsletter.</p>-->
							<form class="newsletter-form" method="POST">
								...
								<div class="input-group input-group-lg">
									...
									<span class="input-group-btn"><button class="btn btn-primary" type="button" id="btn-subscribe-newsletter" data-nonce="<?php echo $nonce; ?>"><i class="fa fa-spinner fa-spin"></i><span>Aanmelden</span></button></span>
								</div>
								<div class="alert"></div>

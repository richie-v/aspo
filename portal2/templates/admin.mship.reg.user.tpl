...
<script>
	...
	function getUsers() {
		...
		//request user data
		$("#ubrowser").load("index.php?m=mship&a=gu&prid={$prid}&n=" + uname);
	}
</script>
...
<div id="main">
	...
	<div id="content">
		...
		<p class="ar">
			<input type="button" class="button" value="Annuleren" onclick="window.location='{$phpself}?m=mship&a=view&prid={$prid}'" />
		</p>

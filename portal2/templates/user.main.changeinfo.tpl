...
<div id="main">
	...
	<div id="content">
		<h2>Gegevens wijzigen</h2>
			...
			<form id="changeinfoform" action="{$phpself}?m=main&a=changeinfodone" method="POST" data-validate="parsley">
		
			<input name="State" type="hidden" value="{if $user.State == 2}1{else}0{/if}" />
